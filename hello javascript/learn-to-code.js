...
var naugthyList = [];
naugthyList.push(studentsNames[0]);

var index = naugthyList.indexOf("Timmy");

console.log(naugthyList);
...
if (nikeSBShoes <= myAccountBalance) {
    ...
    console.log("We just bougth some dope shoes!");
    console.log("Account Balance: " + myAccountBalance);
} else if (nikeSBShoes - coupon <= myAccountBalance) {
    console.log("We just bougth some dope shoes with a coupon!");
...
students.push(new Student("Jimmy","Turner",8));
...
students.push(new Student("Carl","Jr",6));
